...
def generate_launch_description():
    ...
    parking_path = os.path.join(get_package_share_directory('my_autonomous_car'),'world','parking','model.sdf')
    config_dir = os.path.join(get_package_share_directory('my_autonomous_car'), 'config')
    map_file = os.path.join(config_dir, 'robot_parkingobj_map.yaml')
